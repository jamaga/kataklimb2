...
Group.create(name: 'normal climbers', climbing_level: '5', creator_id: 1)
Group.create(name: 'better climbers', climbing_level: '6c', creator_id: 1)
Group.create(name: 'super climbers', climbing_level: '8a', creator_id: 1)
